 ...
 * @return {Boolean}
 */
var isEquals = function(a, b) {  /*Des espaces manquants*/
	return a === b; /*A et B pouvant être également des types, ils faut mettre un opérateur d'identité strict (===)*/
};
...
var add10AndMultiplyBy5 = function(a) {
	return (a + 10) * 5; /*Les parenthèses ayant une priorité plus haute, elle passe en premier, avant la multiplication*/
};
